...
|---|---|---|
| [`product/orbit-product-vision-and-requirements.md`](./product/orbit-product-vision-and-requirements.md) | Requirements and acceptance criteria | Written for Phase 1 |
...
| Document | Covers |
|---|---|
| [`architecture/decisions.md`](./architecture/decisions.md) | **The decision log — 35 ADRs.** The authoritative record of why Orbit is shaped as it is |
| [`architecture/phase-1-system-design.md`](./architecture/phase-1-system-design.md) | The Phase 1 system design |
| [`architecture/task-5-artifact-storage-preflight.md`](./architecture/task-5-artifact-storage-preflight.md) | Artifact storage design work |
