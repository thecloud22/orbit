...
| [`architecture/decisions.md`](./architecture/decisions.md) | **The decision log — 35 ADRs**, each with a status and an index. The authoritative record of why Orbit is shaped as it is | Active, maintained continuously |
...
Nine of the 35 ADRs carry a qualifier — *Partially implemented*, or *amended /
